...
const writeStartingContent = {
  ...
  content:
    "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corrupti quas officiis laboriosam fugit saepe in. Perspiciatis nisi est ratione inventore. Quaerat error tempore numquam vitae, deleniti atque. Delectus, aperiam suscipit? Aliquid velit quaerat accusantium quisquam.",
};

const aboutStartingContent = {
  title:
    "Radium is similar to Medium blogging site, developed as a learning project.",
  content:
